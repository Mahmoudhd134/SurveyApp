        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAgent = table.Column<string>(type: "nvarchar(511)", maxLength: 511, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRefreshTokens_UserId_UserAgent",
                table: "UserRefreshTokens",
                columns: new[] { "UserId", "UserAgent" },
                unique: true,
                filter: "[UserId] IS NOT NULL AND [UserAgent] IS NOT NULL");
        }
